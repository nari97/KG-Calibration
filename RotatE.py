...
class RotatE(Model):
    ...
    def _calc(self, h, t, r, mode):
        ...
        # Originally; however, rel_embedding_range was computed based on margin and epsilon. Since the original paper
        #   says that this is initialized between 0 and 2pi, we used rel_embedding_range = 2pi
